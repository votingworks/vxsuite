...
export const appStrings = {
  ...
  hmpbOfficialBallot: () => (
    <UiString uiStringKey="hmpbOfficialBallot">Official Ballot</UiString>
  ),

  hmpbSampleBallot: () => (
    <UiString uiStringKey="hmpbSampleBallot">Sample Ballot</UiString>
  ),

  hmpbTestBallot: () => (
    <UiString uiStringKey="hmpbTestBallot">Test Ballot</UiString>
  ),

  hmpbOfficialAbsenteeBallot: () => (
    <UiString uiStringKey="hmpbOfficialAbsenteeBallot">
      Official Absentee Ballot
    </UiString>
  ),

  hmpbSampleAbsenteeBallot: () => (
    <UiString uiStringKey="hmpbSampleAbsenteeBallot">
      Sample Absentee Ballot
    </UiString>
  ),

  hmpbTestAbsenteeBallot: () => (
    <UiString uiStringKey="hmpbTestAbsenteeBallot">
      Test Absentee Ballot
    </UiString>
  ),

  hmpbOfficialProvisionalBallot: () => (
    <UiString uiStringKey="hmpbOfficialProvisionalBallot">
      Official Provisional Ballot
    </UiString>
  ),

  hmpbSampleProvisionalBallot: () => (
    <UiString uiStringKey="hmpbSampleProvisionalBallot">
      Sample Provisional Ballot
    </UiString>
  ),

  hmpbTestProvisionalBallot: () => (
    <UiString uiStringKey="hmpbTestProvisionalBallot">
      Test Provisional Ballot
    </UiString>
  ),

  hmpbInstructions: () => (
    <UiString uiStringKey="hmpbInstructions">Instructions</UiString>
  ),

  hmpbInstructionsToVoteTitle: () => (
    <UiString uiStringKey="hmpbInstructionsToVoteTitle">To Vote:</UiString>
  ),

  hmpbInstructionsToVoteText: () => (
    <UiString uiStringKey="hmpbInstructionsToVoteText">
      To vote, completely fill in the oval next to your choice.
    </UiString>
  ),

  hmpbInstructionsWriteInTitle: () => (
    <UiString uiStringKey="hmpbInstructionsWriteInTitle">
      To Vote for a Write-in:
    </UiString>
  ),

  hmpbInstructionsWriteInText: () => (
    <UiString uiStringKey="hmpbInstructionsWriteInText">
      To vote for a person whose name is not on the ballot, write the person’s
      name on the "Write-in" line and completely fill in the oval next to the
      line.
    </UiString>
  ),

  hmpbVoteFor1: () => (
    <UiString uiStringKey="hmpbVoteFor1">Vote for 1</UiString>
  ),

  hmpbVoteFor2: () => (
    <UiString uiStringKey="hmpbVoteFor2">Vote for up to 2</UiString>
  ),

  hmpbVoteFor3: () => (
    <UiString uiStringKey="hmpbVoteFor3">Vote for up to 3</UiString>
  ),

  hmpbVoteFor4: () => (
    <UiString uiStringKey="hmpbVoteFor4">Vote for up to 4</UiString>
  ),

  hmpbVoteFor5: () => (
    <UiString uiStringKey="hmpbVoteFor5">Vote for up to 5</UiString>
  ),

  hmpbVoteFor6: () => (
    <UiString uiStringKey="hmpbVoteFor6">Vote for up to 6</UiString>
  ),

  hmpbVoteFor7: () => (
    <UiString uiStringKey="hmpbVoteFor7">Vote for up to 7</UiString>
  ),

  hmpbVoteFor8: () => (
    <UiString uiStringKey="hmpbVoteFor8">Vote for up to 8</UiString>
  ),

  hmpbVoteFor9: () => (
    <UiString uiStringKey="hmpbVoteFor9">Vote for up to 9</UiString>
  ),

  hmpbVoteFor10: () => (
    <UiString uiStringKey="hmpbVoteFor10">Vote for up to 10</UiString>
  ),

  hmpbWriteIn: () => <UiString uiStringKey="hmpbWriteIn">Write-in</UiString>,

  hmpbPageIntentionallyBlank: () => (
    <UiString uiStringKey="hmpbPageIntentionallyBlank">
      This page intentionally left blank
    </UiString>
  ),

  hmpbContinueVotingOnBack: () => (
    <UiString uiStringKey="hmpbContinueVotingOnBack">
      Turn ballot over and continue voting
    </UiString>
  ),

  hmpbContinueVotingOnNextSheet: () => (
    <UiString uiStringKey="hmpbContinueVotingOnNextSheet">
      Continue voting on next ballot sheet
    </UiString>
  ),

  hmpbVotingComplete: () => (
    <UiString uiStringKey="hmpbVotingComplete">
      You have completed voting.
    </UiString>
  ),

  hmpbPage: () => <UiString uiStringKey="hmpbPage">Page</UiString>,
