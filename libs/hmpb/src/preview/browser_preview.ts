 ...
 * entry point and props). Expects an election JSON file to be placed in this
 * package's preview public dir (e.g. public/nh-rov/), trimmed to just the
 * target ballot style — we always render ballotStyles[0].
 *
