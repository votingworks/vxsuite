...
export const hmpbStringsCatalog = {
  ...
  hmpbVoteForNotMoreThan2: 'Vote for not more than 2',
  hmpbVoteForNotMoreThan3: 'Vote for not more than 3',
  hmpbVoteForNotMoreThan4: 'Vote for not more than 4',
  hmpbVoteForNotMoreThan5: 'Vote for not more than 5',
  hmpbVoteForNotMoreThan6: 'Vote for not more than 6',
  hmpbVoteForNotMoreThan7: 'Vote for not more than 7',
  hmpbVoteForNotMoreThan8: 'Vote for not more than 8',
  hmpbVoteForNotMoreThan9: 'Vote for not more than 9',
  hmpbVoteForNotMoreThan10: 'Vote for not more than 10',
  hmpb2WillBeElected: 'Two will be elected',
  hmpb3WillBeElected: 'Three will be elected',
  hmpb4WillBeElected: 'Four will be elected',
  hmpb5WillBeElected: 'Five will be elected',
  hmpb6WillBeElected: 'Six will be elected',
  hmpb7WillBeElected: 'Seven will be elected',
  hmpb8WillBeElected: 'Eight will be elected',
  hmpb9WillBeElected: 'Nine will be elected',
  hmpb10WillBeElected: 'Ten will be elected',
