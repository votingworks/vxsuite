...
export interface BallotMeasureContest {
  ...
  readonly ContestSelection: ReadonlyArray<
    ContestSelection | BallotMeasureSelection | CandidateSelection
  >;
...
export const BallotMeasureContestSchema: z.ZodSchema<BallotMeasureContest> =
  z.object({
    ...
    Code: z.optional(
      z.array(z.lazy(/* istanbul ignore next - @preserve */ () => CodeSchema))
    ),
    ContestSelection: z
      .array(
        z.union([
          z.lazy(
            /* istanbul ignore next - @preserve */ () => ContestSelectionSchema
          ),
          z.lazy(
...
export const CVRSchema: z.ZodSchema<CVR> = z.object({
  ...
  BallotImage: z.optional(
    z.array(
      z.lazy(/* istanbul ignore next - @preserve */ () => ImageDataSchema)
    )
  ),
  ...
  CVRSnapshot: z
    .array(
      z.lazy(/* istanbul ignore next - @preserve */ () => CVRSnapshotSchema)
    )
    .min(1),
...
export const CVRContestSchema: z.ZodSchema<CVRContest> = z.object({
  ...
  CVRContestSelection: z.array(
    z.lazy(
      /* istanbul ignore next - @preserve */ () => CVRContestSelectionSchema
    )
  ),
  ContestId: z.string(),
  ...
  Status: z.optional(
    z.array(
      z.lazy(/* istanbul ignore next - @preserve */ () => ContestStatusSchema)
    )
  ),
...
export const CVRContestSelectionSchema: z.ZodSchema<CVRContestSelection> =
  z.object({
    ...
    SelectionPosition: z
      .array(
        z.lazy(
          /* istanbul ignore next - @preserve */ () => SelectionPositionSchema
        )
      )
      .min(1),
    Status: z.optional(
      z.array(
        z.lazy(
          /* istanbul ignore next - @preserve */ () =>
            ContestSelectionStatusSchema
        )
      )
    ),
    TotalFractionalVotes: z.optional(
      z.lazy(
        /* istanbul ignore next - @preserve */ () => FractionalNumberSchema
      )
    ),
...
export const CVRSnapshotSchema: z.ZodSchema<CVRSnapshot> = z.object({
  ...
  Annotation: z.optional(
    z.array(
      z.lazy(/* istanbul ignore next - @preserve */ () => AnnotationSchema)
    )
  ),
  CVRContest: z.array(
    z.lazy(/* istanbul ignore next - @preserve */ () => CVRContestSchema)
  ),
  OtherStatus: z.optional(z.string()),
  Status: z.optional(
    z.array(
      z.lazy(/* istanbul ignore next - @preserve */ () => CVRStatusSchema)
    )
  ),
...
export const CastVoteRecordReportSchema: z.ZodSchema<CastVoteRecordReport> =
  z.object({
    ...
    CVR: z.optional(
      z.array(z.lazy(/* istanbul ignore next - @preserve */ () => CVRSchema))
    ),
    Election: z
      .array(
        z.lazy(/* istanbul ignore next - @preserve */ () => ElectionSchema)
      )
      .min(1),
    GeneratedDate: DateTimeSchema,
    GpUnit: z
      .array(z.lazy(/* istanbul ignore next - @preserve */ () => GpUnitSchema))
      .min(1),
    Notes: z.optional(z.string()),
    OtherReportType: z.optional(z.string()),
    Party: z.optional(
      z.array(z.lazy(/* istanbul ignore next - @preserve */ () => PartySchema))
    ),
    ReportGeneratingDeviceIds: z.array(z.string()).min(1),
    ReportType: z.optional(
      z.array(
        z.lazy(/* istanbul ignore next - @preserve */ () => ReportTypeSchema)
      )
    ),
    ReportingDevice: z
      .array(
      ...
      .min(1),
    Version: z.lazy(
      /* istanbul ignore next - @preserve */ () => CastVoteRecordVersionSchema
    ),
  });
...
export interface Election {
  ...
  readonly Contest: ReadonlyArray<
    Contest | BallotMeasureContest | CandidateContest
  >;
...
export const ElectionSchema: z.ZodSchema<Election> = z.object({
  ...
  Contest: z
    .array(
      z.union([
        z.lazy(/* istanbul ignore next - @preserve */ () => ContestSchema),
        z.lazy(
          /* istanbul ignore next - @preserve */ () =>
...
export const ImageDataSchema: z.ZodSchema<ImageData> = z.object({
  ...
  Hash: z.optional(
    z.lazy(/* istanbul ignore next - @preserve */ () => HashSchema)
  ),
  Image: z.optional(
    z.lazy(/* istanbul ignore next - @preserve */ () => ImageSchema)
  ),
...
export const SelectionPositionSchema: z.ZodSchema<SelectionPosition> = z.object(
  {
    ...
    CVRWriteIn: z.optional(
      z.lazy(/* istanbul ignore next - @preserve */ () => CVRWriteInSchema)
    ),
    Code: z.optional(
      z.array(z.lazy(/* istanbul ignore next - @preserve */ () => CodeSchema))
    ),
    ...
    HasIndication: z.lazy(
      /* istanbul ignore next - @preserve */ () => IndicationStatusSchema
    ),
    IsAllocable: z.optional(
      z.lazy(
        /* istanbul ignore next - @preserve */ () => AllocationStatusSchema
      )
    ),
    ...
    Status: z.optional(
      z.array(
        z.lazy(
          /* istanbul ignore next - @preserve */ () => PositionStatusSchema
        )
      )
    ),
  }
