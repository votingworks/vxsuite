...
export const BallotMeasureContestSchema: z.ZodSchema<BallotMeasureContest> = z.object({
  ...
  Code: z.optional(z.array(z.lazy(() => CodeSchema))),
  ContestSelection: z.array(z.union([z.lazy(() => ContestSelectionSchema), z.lazy(() => BallotMeasureSelectionSchema), z.lazy(() => CandidateSelectionSchema)])).min(1),
...
export const CVRSchema: z.ZodSchema<CVR> = z.object({
  ...
  BallotImage: z.optional(z.array(z.lazy(() => ImageDataSchema))),
  ...
  CVRSnapshot: z.array(z.lazy(() => CVRSnapshotSchema)).min(1),
...
export const CVRContestSchema: z.ZodSchema<CVRContest> = z.object({
  ...
  CVRContestSelection: z.array(z.lazy(() => CVRContestSelectionSchema)),
  ContestId: z.string(),
  OtherStatus: z.optional(z.string()),
  Overvotes: z.optional(integerSchema),
  Selections: z.optional(integerSchema),
  Status: z.optional(z.array(z.lazy(() => ContestStatusSchema))),
...
export const CVRContestSelectionSchema: z.ZodSchema<CVRContestSelection> = z.object({
  ...
  SelectionPosition: z.array(z.lazy(() => SelectionPositionSchema)).min(1),
  Status: z.optional(z.array(z.lazy(() => ContestSelectionStatusSchema))),
  TotalFractionalVotes: z.optional(z.lazy(() => FractionalNumberSchema)),
...
export const CVRSnapshotSchema: z.ZodSchema<CVRSnapshot> = z.object({
  ...
  Annotation: z.optional(z.array(z.lazy(() => AnnotationSchema))),
  CVRContest: z.array(z.lazy(() => CVRContestSchema)),
  OtherStatus: z.optional(z.string()),
  Status: z.optional(z.array(z.lazy(() => CVRStatusSchema))),
  Type: z.lazy(() => CVRTypeSchema),
});
...
export const CVRWriteInSchema: z.ZodSchema<CVRWriteIn> = z.object({
  ...
  WriteInImage: z.optional(z.lazy(() => ImageDataSchema)),
});
...
export const CandidateContestSchema: z.ZodSchema<CandidateContest> = z.object({
  ...
  Abbreviation: z.optional(z.string()),
  Code: z.optional(z.array(z.lazy(() => CodeSchema))),
  ContestSelection: z.array(z.union([z.lazy(() => ContestSelectionSchema), z.lazy(() => PartySelectionSchema), z.lazy(() => BallotMeasureSelectionSchema), z.lazy(() => CandidateSelectionSchema)])).min(1),
  Name: z.optional(z.string()),
...
export const CastVoteRecordReportSchema: z.ZodSchema<CastVoteRecordReport> = z.object({
  ...
  CVR: z.optional(z.array(z.lazy(() => CVRSchema))),
  Election: z.array(z.lazy(() => ElectionSchema)).min(1),
  GeneratedDate: DateTimeSchema,
  GpUnit: z.array(z.lazy(() => GpUnitSchema)).min(1),
  Notes: z.optional(z.string()),
  OtherReportType: z.optional(z.string()),
  Party: z.optional(z.array(z.lazy(() => PartySchema))),
  ReportGeneratingDeviceIds: z.array(z.string()).min(1),
  ReportType: z.optional(z.array(z.lazy(() => ReportTypeSchema))),
  ReportingDevice: z.array(z.lazy(() => ReportingDeviceSchema)).min(1),
  Version: z.lazy(() => CastVoteRecordVersionSchema),
});
...
export const ElectionSchema: z.ZodSchema<Election> = z.object({
  ...
  Code: z.optional(z.array(z.lazy(() => CodeSchema))),
  Contest: z.array(z.union([z.lazy(() => ContestSchema), z.lazy(() => PartyContestSchema), z.lazy(() => BallotMeasureContestSchema), z.lazy(() => CandidateContestSchema)])).min(1),
...
export const ImageDataSchema: z.ZodSchema<ImageData> = z.object({
  ...
  Hash: z.optional(z.lazy(() => HashSchema)),
...
export const SelectionPositionSchema: z.ZodSchema<SelectionPosition> = z.object({
  ...
  CVRWriteIn: z.optional(z.lazy(() => CVRWriteInSchema)),
  Code: z.optional(z.array(z.lazy(() => CodeSchema))),
  FractionalVotes: z.optional(z.lazy(() => FractionalNumberSchema)),
  HasIndication: z.lazy(() => IndicationStatusSchema),
  IsAllocable: z.optional(z.lazy(() => AllocationStatusSchema)),
  ...
  Rank: z.optional(integerSchema),
  Status: z.optional(z.array(z.lazy(() => PositionStatusSchema))),
});
