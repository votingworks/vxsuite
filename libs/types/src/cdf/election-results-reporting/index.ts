...
export const AnnotatedStringSchema: z.ZodSchema<AnnotatedString> = z.object({
  ...
  Annotation: z.optional(z.lazy(() => ShortStringSchema)),
  Content: z.string(),
});
...
export const BallotMeasureContestSchema: z.ZodSchema<BallotMeasureContest> = z.object({
  ...
  BallotSubTitle: z.optional(z.lazy(() => InternationalizedTextSchema)),
  BallotTitle: z.optional(z.lazy(() => InternationalizedTextSchema)),
  ConStatement: z.optional(z.lazy(() => InternationalizedTextSchema)),
  ContestSelection: z.optional(z.array(z.union([z.lazy(() => PartySelectionSchema), z.lazy(() => BallotMeasureSelectionSchema), z.lazy(() => CandidateSelectionSchema)]))),
  CountStatus: z.optional(z.array(z.lazy(() => CountStatusSchema))),
  EffectOfAbstain: z.optional(z.lazy(() => InternationalizedTextSchema)),
  ElectionDistrictId: z.string(),
  ExternalIdentifier: z.optional(z.array(z.lazy(() => ExternalIdentifierSchema))),
  FullText: z.optional(z.lazy(() => InternationalizedTextSchema)),
  HasRotation: z.optional(z.boolean()),
  InfoUri: z.optional(z.array(z.lazy(() => AnnotatedUriSchema))),
  Name: z.string(),
  OtherCounts: z.optional(z.array(z.lazy(() => OtherCountsSchema))),
  OtherType: z.optional(z.string()),
  OtherVoteVariation: z.optional(z.string()),
  PassageThreshold: z.optional(z.lazy(() => InternationalizedTextSchema)),
  ProStatement: z.optional(z.lazy(() => InternationalizedTextSchema)),
  SequenceOrder: z.optional(integerSchema),
  SubUnitsReported: z.optional(integerSchema),
  SummaryText: z.optional(z.lazy(() => InternationalizedTextSchema)),
  TotalSubUnits: z.optional(integerSchema),
  Type: z.optional(z.lazy(() => BallotMeasureTypeSchema)),
  VoteVariation: z.optional(z.lazy(() => VoteVariationSchema)),
});
...
export const BallotMeasureSelectionSchema: z.ZodSchema<BallotMeasureSelection> = z.object({
  ...
  SequenceOrder: z.optional(integerSchema),
  VoteCounts: z.optional(z.array(z.lazy(() => VoteCountsSchema))),
});
...
export const BallotStyleSchema: z.ZodSchema<BallotStyle> = z.object({
  ...
  ImageUri: z.optional(z.array(z.lazy(() => AnnotatedUriSchema))),
  OrderedContent: z.optional(z.array(z.union([z.lazy(() => OrderedContestSchema), z.lazy(() => OrderedHeaderSchema)]))),
...
export const CandidateSchema: z.ZodSchema<Candidate> = z.object({
  ...
  ContactInformation: z.optional(z.lazy(() => ContactInformationSchema)),
  ExternalIdentifier: z.optional(z.array(z.lazy(() => ExternalIdentifierSchema))),
  ...
  PostElectionStatus: z.optional(z.lazy(() => CandidatePostElectionStatusSchema)),
  PreElectionStatus: z.optional(z.lazy(() => CandidatePreElectionStatusSchema)),
});
...
export const CoalitionSchema: z.ZodSchema<Coalition> = z.object({
  ...
  Abbreviation: z.optional(z.lazy(() => InternationalizedTextSchema)),
  Color: z.optional(z.lazy(() => HtmlColorStringSchema)),
  ContactInformation: z.optional(z.lazy(() => ContactInformationSchema)),
  ContestIds: z.optional(z.array(z.string())),
  ExternalIdentifier: z.optional(z.array(z.lazy(() => ExternalIdentifierSchema))),
  IsRecognizedParty: z.optional(z.boolean()),
  LeaderPersonIds: z.optional(z.array(z.string())),
  LogoUri: z.optional(z.array(z.lazy(() => AnnotatedUriSchema))),
  Name: z.lazy(() => InternationalizedTextSchema),
  PartyIds: z.optional(z.array(z.string())),
  PartyScopeGpUnitIds: z.optional(z.array(z.string())),
  Slogan: z.optional(z.lazy(() => InternationalizedTextSchema)),
});
...
export const ContactInformationSchema: z.ZodSchema<ContactInformation> = z.object({
  ...
  Directions: z.optional(z.lazy(() => InternationalizedTextSchema)),
  Email: z.optional(z.array(z.lazy(() => AnnotatedStringSchema))),
  Fax: z.optional(z.array(z.lazy(() => AnnotatedStringSchema))),
  Label: z.optional(z.string()),
  LatLng: z.optional(z.lazy(() => LatLngSchema)),
  Name: z.optional(z.string()),
  Phone: z.optional(z.array(z.lazy(() => AnnotatedStringSchema))),
  Schedule: z.optional(z.array(z.lazy(() => ScheduleSchema))),
  Uri: z.optional(z.array(z.lazy(() => AnnotatedUriSchema))),
});
...
export const CountStatusSchema: z.ZodSchema<CountStatus> = z.object({
  ...
  OtherType: z.optional(z.string()),
  Status: z.lazy(() => CountItemStatusSchema),
  Type: z.lazy(() => CountItemTypeSchema),
});
...
export const ElectionSchema: z.ZodSchema<Election> = z.object({
  ...
  BallotCounts: z.optional(z.array(z.lazy(() => BallotCountsSchema))),
  BallotStyle: z.optional(z.array(z.lazy(() => BallotStyleSchema))),
  Candidate: z.optional(z.array(z.lazy(() => CandidateSchema))),
  ContactInformation: z.optional(z.lazy(() => ContactInformationSchema)),
  Contest: z.optional(z.array(z.union([z.lazy(() => PartyContestSchema), z.lazy(() => BallotMeasureContestSchema), z.lazy(() => CandidateContestSchema), z.lazy(() => RetentionContestSchema)]))),
  CountStatus: z.optional(z.array(z.lazy(() => CountStatusSchema))),
...
export const ElectionReportSchema: z.ZodSchema<ElectionReport> = z.object({
  ...
  Election: z.optional(z.array(z.lazy(() => ElectionSchema))),
  ExternalIdentifier: z.optional(z.array(z.lazy(() => ExternalIdentifierSchema))),
  Format: z.lazy(() => ReportDetailLevelSchema),
  GeneratedDate: z.lazy(() => DateTimeWithZoneSchema),
  GpUnit: z.optional(z.array(z.union([z.lazy(() => ReportingDeviceSchema), z.lazy(() => ReportingUnitSchema)]))),
  ...
  OfficeGroup: z.optional(z.array(z.lazy(() => OfficeGroupSchema))),
  Party: z.optional(z.array(z.union([z.lazy(() => PartySchema), z.lazy(() => CoalitionSchema)]))),
  Person: z.optional(z.array(z.lazy(() => PersonSchema))),
  SequenceEnd: integerSchema,
  SequenceStart: integerSchema,
  Status: z.lazy(() => ResultsStatusSchema),
...
export const HoursSchema: z.ZodSchema<Hours> = z.object({
  ...
  Day: z.optional(z.lazy(() => DayTypeSchema)),
  EndTime: z.lazy(() => TimeWithZoneSchema),
  Label: z.optional(z.string()),
  StartTime: z.lazy(() => TimeWithZoneSchema),
});
...
export const OfficeSchema: z.ZodSchema<Office> = z.object({
  ...
  ContactInformation: z.optional(z.lazy(() => ContactInformationSchema)),
  Description: z.optional(z.lazy(() => InternationalizedTextSchema)),
  ...
  Term: z.optional(z.lazy(() => TermSchema)),
});
...
export const OfficeGroupSchema: z.ZodSchema<OfficeGroup> = z.object({
  ...
  Name: z.string(),
  OfficeIds: z.optional(z.array(z.string())),
  SubOfficeGroup: z.optional(z.array(z.lazy(() => OfficeGroupSchema))),
});
...
export const PersonSchema: z.ZodSchema<Person> = z.object({
  ...
  ContactInformation: z.optional(z.array(z.lazy(() => ContactInformationSchema))),
  DateOfBirth: z.optional(DateSchema),
  ExternalIdentifier: z.optional(z.array(z.lazy(() => ExternalIdentifierSchema))),
  FirstName: z.optional(z.string()),
  FullName: z.optional(z.lazy(() => InternationalizedTextSchema)),
  ...
  Profession: z.optional(z.lazy(() => InternationalizedTextSchema)),
  Suffix: z.optional(z.string()),
  Title: z.optional(z.lazy(() => InternationalizedTextSchema)),
});
...
export const ReportingDeviceSchema: z.ZodSchema<ReportingDevice> = z.object({
  ...
  DeviceClass: z.optional(z.lazy(() => DeviceClassSchema)),
  ExternalIdentifier: z.optional(z.array(z.lazy(() => ExternalIdentifierSchema))),
  Name: z.optional(z.lazy(() => InternationalizedTextSchema)),
...
export const ReportingUnitSchema: z.ZodSchema<ReportingUnit> = z.object({
  ...
  ContactInformation: z.optional(z.lazy(() => ContactInformationSchema)),
  CountStatus: z.optional(z.array(z.lazy(() => CountStatusSchema))),
  ElectionAdministration: z.optional(z.lazy(() => ElectionAdministrationSchema)),
  ExternalIdentifier: z.optional(z.array(z.lazy(() => ExternalIdentifierSchema))),
  ...
  OtherType: z.optional(z.string()),
  PartyRegistration: z.optional(z.array(z.lazy(() => PartyRegistrationSchema))),
  SpatialDimension: z.optional(z.lazy(() => SpatialDimensionSchema)),
  SubUnitsReported: z.optional(integerSchema),
  TotalSubUnits: z.optional(integerSchema),
...
export const ScheduleSchema: z.ZodSchema<Schedule> = z.object({
  ...
  Hours: z.optional(z.array(z.lazy(() => HoursSchema))),
...
export const SpatialDimensionSchema: z.ZodSchema<SpatialDimension> = z.object({
  ...
  MapUri: z.optional(z.array(z.lazy(() => AnnotatedUriSchema))),
  SpatialExtent: z.optional(z.lazy(() => SpatialExtentSchema)),
});
...
export const SpatialExtentSchema: z.ZodSchema<SpatialExtent> = z.object({
  ...
  Format: z.lazy(() => GeoSpatialFormatSchema),
});
...
export const TermSchema: z.ZodSchema<Term> = z.object({
  ...
  Label: z.optional(z.string()),
  StartDate: z.optional(DateSchema),
  Type: z.optional(z.lazy(() => OfficeTermTypeSchema)),
});
