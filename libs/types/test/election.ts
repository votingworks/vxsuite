...
const electionPrimaryNonpartisanContestsData = `
{
  "title": "Example Primary Election",
  "state": "State of Sample",
  "county": {
  ...
  "contests": [
    ...
    },
    {
      ...
      "districtId": "district-1",
      "type": "yesno",
      "title": "Kingdom Preference",
      "description": "Are fish better than mammals?",
      "yesOption": {
        "id": "fish-better",
        "label": "YES"
      },
...
export const electionPrimaryNonpartisanContests: Election = safeParseElection(
  electionPrimaryNonpartisanContestsData
).unsafeUnwrap();
