...
pub(crate) fn ui(app: &App, f: &mut Frame<'_>) {
                ...
                (
                    ...
                    Line::from(vec![
                        ...
                        Span::raw(format!(
                            ...
                            if let EjectDirection::BackDrop = scanner.get_eject_direction() {
                                "☑️"
                            } else {
                                "☐"
                            }
                    ...
                    Line::from(vec![
                        ...
                        Span::raw(format!(
                            ...
                            if let EjectDirection::BackHold = scanner.get_eject_direction() {
                                "☑️"
                            } else {
                                "☐"
                            }
                    ...
                    Line::from(vec![
                        ...
                        Span::raw(format!(
                            ...
                            if let EjectDirection::FrontDrop = scanner.get_eject_direction() {
                                "☑️"
                            } else {
                                "☐"
                            }
                    ...
                    Line::from(vec![
                        ...
                        Span::raw(format!(
                            ...
                            if let EjectDirection::FrontHold = scanner.get_eject_direction() {
                                "☑️"
                            } else {
                                "☐"
                            }
                    ...
                    Line::from(vec![
                        ...
                        Span::raw(format!(
                            ...
                            EJECT_DELAY_STEP,
                            scanner.get_eject_delay() + EJECT_DELAY_STEP
                        )),
                    ]),
                    Line::from(vec![
                        Span::raw("  -").bold(),
