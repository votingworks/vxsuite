...
pub enum DoubleFeedDetectionMode {
    ...
    /// 3.25 inch wide document size.
    #[serde(rename = "alternate")]
    Alternate,
}

impl TryFrom<u8> for DoubleFeedDetectionMode {
    type Error = ();
...
impl From<DoubleFeedDetectionMode> for u8 {
    fn from(value: DoubleFeedDetectionMode) -> Self {
        match value {
            DoubleFeedDetectionMode::Default => 5,
            DoubleFeedDetectionMode::Alternate => 6,
        }
    }
}
