...
> all imports follow a uniform pattern. Default exports provide no canonical
> name, which makes central maintenance difficult with relatively little benefit
> to code owners, including potentially decreased readability.
