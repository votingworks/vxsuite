...
import rule from '../../src/rules/no_esm_workspace_import_in_test_setup.js';
...
ruleTester.run('no-esm-workspace-import-in-test-setup', rule, {
  valid: [
    ...
    // imports of its own.
    {
      code: `import { a } from '@votingworks/esm-lib/safe'`,
      filename,
      options: [{ allow: ['@votingworks/esm-lib/safe'] }],
    },
  ],
  invalid: [
    {
    ...
    {
      // Allowing one specifier does not allow its siblings: matches are exact.
      code: `import { a } from '@votingworks/esm-lib/unsafe'`,
      filename,
      options: [{ allow: ['@votingworks/esm-lib/safe'] }],
      errors: [
        {
