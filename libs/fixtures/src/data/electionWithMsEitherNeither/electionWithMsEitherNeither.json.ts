...
/**
 * Get the path to the resource data/electionWithMsEitherNeither/electionWithMsEitherNeither.json.
 */
...
/**
 * Election package for data/electionWithMsEitherNeither/electionWithMsEitherNeither.json.
 */
