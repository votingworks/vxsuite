...
/**
 * Get the path to the resource data/sample-ballot-images/not-a-ballot.jpg.
 */
function getResourcePath(): string {
  let rootDir = __dirname;
  do {
    if (existsSync(join(rootDir, 'package.json'))) {
      return join(rootDir, 'data/sample-ballot-images/not-a-ballot.jpg');
    }
...
/**
 * MIME type of data/sample-ballot-images/not-a-ballot.jpg.
 */
...
export function asFilePath(): string {
  ...
  const filePath = join(directoryPath, 'not-a-ballot.jpg');
  cpSync(getResourcePath(), filePath);
  return filePath;
}

/**
 * Convert to a `data:` URL of data/sample-ballot-images/not-a-ballot.jpg, suitable for embedding in HTML.
 */
...
/**
 * Raw data of data/sample-ballot-images/not-a-ballot.jpg.
 */
