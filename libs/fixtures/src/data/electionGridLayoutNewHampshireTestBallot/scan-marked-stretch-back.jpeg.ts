...
/**
 * Get the path to the resource data/electionGridLayoutNewHampshireTestBallot/scan-marked-stretch-back.jpeg.
 */
...
/**
 * MIME type of data/electionGridLayoutNewHampshireTestBallot/scan-marked-stretch-back.jpeg.
 */
...
export function asFilePath(): string {
  ...
  const filePath = join(directoryPath, 'scan-marked-stretch-back.jpeg');
  cpSync(getResourcePath(), filePath);
  return filePath;
}

/**
 * Convert to a `data:` URL of data/electionGridLayoutNewHampshireTestBallot/scan-marked-stretch-back.jpeg, suitable for embedding in HTML.
 */
...
/**
 * Raw data of data/electionGridLayoutNewHampshireTestBallot/scan-marked-stretch-back.jpeg.
 */
