...
/**
 * Get the path to the resource data/electionGridLayoutNewHampshireTestBallot/scan-marked-grainy-timing-marks-back.jpeg.
 */
...
/**
 * MIME type of data/electionGridLayoutNewHampshireTestBallot/scan-marked-grainy-timing-marks-back.jpeg.
 */
...
export function asFilePath(): string {
  ...
  const filePath = join(
    directoryPath,
    'scan-marked-grainy-timing-marks-back.jpeg'
  );
...
/**
 * Convert to a `data:` URL of data/electionGridLayoutNewHampshireTestBallot/scan-marked-grainy-timing-marks-back.jpeg, suitable for embedding in HTML.
 */
...
/**
 * Raw data of data/electionGridLayoutNewHampshireTestBallot/scan-marked-grainy-timing-marks-back.jpeg.
 */
