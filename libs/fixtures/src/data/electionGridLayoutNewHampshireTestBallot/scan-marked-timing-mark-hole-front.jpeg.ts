...
/**
 * Get the path to the resource data/electionGridLayoutNewHampshireTestBallot/scan-marked-timing-mark-hole-front.jpeg.
 */
...
/**
 * MIME type of data/electionGridLayoutNewHampshireTestBallot/scan-marked-timing-mark-hole-front.jpeg.
 */
...
export function asFilePath(): string {
  ...
  const filePath = join(
    directoryPath,
    'scan-marked-timing-mark-hole-front.jpeg'
  );
...
/**
 * Convert to a `data:` URL of data/electionGridLayoutNewHampshireTestBallot/scan-marked-timing-mark-hole-front.jpeg, suitable for embedding in HTML.
 */
...
/**
 * Raw data of data/electionGridLayoutNewHampshireTestBallot/scan-marked-timing-mark-hole-front.jpeg.
 */
