...
/**
 * Get the path to the resource data/electionGridLayoutNewHampshireTestBallot/scan-marked-overvote-front.jpeg.
 */
...
/**
 * MIME type of data/electionGridLayoutNewHampshireTestBallot/scan-marked-overvote-front.jpeg.
 */
...
export function asFilePath(): string {
  ...
  const filePath = join(directoryPath, 'scan-marked-overvote-front.jpeg');
  cpSync(getResourcePath(), filePath);
  return filePath;
}

/**
 * Convert to a `data:` URL of data/electionGridLayoutNewHampshireTestBallot/scan-marked-overvote-front.jpeg, suitable for embedding in HTML.
 */
...
/**
 * Raw data of data/electionGridLayoutNewHampshireTestBallot/scan-marked-overvote-front.jpeg.
 */
