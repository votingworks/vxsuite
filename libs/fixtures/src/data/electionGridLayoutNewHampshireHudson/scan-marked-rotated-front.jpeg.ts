...
/**
 * Get the path to the resource data/electionGridLayoutNewHampshireHudson/scan-marked-rotated-front.jpeg.
 */
...
/**
 * MIME type of data/electionGridLayoutNewHampshireHudson/scan-marked-rotated-front.jpeg.
 */
...
export function asFilePath(): string {
  ...
  const filePath = join(directoryPath, 'scan-marked-rotated-front.jpeg');
  cpSync(getResourcePath(), filePath);
  return filePath;
}

/**
 * Convert to a `data:` URL of data/electionGridLayoutNewHampshireHudson/scan-marked-rotated-front.jpeg, suitable for embedding in HTML.
 */
...
/**
 * Raw data of data/electionGridLayoutNewHampshireHudson/scan-marked-rotated-front.jpeg.
 */
