...
/**
 * Get the path to the resource data/electionGeneral/election.json.
 */
function getResourcePath(): string {
  let rootDir = __dirname;
  do {
    if (existsSync(join(rootDir, 'package.json'))) {
      return join(rootDir, 'data/electionGeneral/election.json');
    }
...
/**
 * MIME type of data/electionGeneral/election.json.
 */
...
/**
 * Convert to a `data:` URL of data/electionGeneral/election.json, suitable for embedding in HTML.
 */
...
/**
 * Raw data of data/electionGeneral/election.json.
 */
...
/**
 * Text content of data/electionGeneral/election.json.
 */
...
/**
 * Full election definition for data/electionGeneral/election.json.
 */
...
/**
 * Election definition for data/electionGeneral/election.json.
 */
...
/**
 * Election package for data/electionGeneral/election.json.
 */
