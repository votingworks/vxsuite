...
/**
 * Get the path to the resource data/electionTwoPartyPrimary/csvFiles/finalResults.csv.
 */
...
/**
 * MIME type of data/electionTwoPartyPrimary/csvFiles/finalResults.csv.
 */
...
/**
 * Convert to a `data:` URL of data/electionTwoPartyPrimary/csvFiles/finalResults.csv, suitable for embedding in HTML.
 */
...
/**
 * Raw data of data/electionTwoPartyPrimary/csvFiles/finalResults.csv.
 */
...
/**
 * Text content of data/electionTwoPartyPrimary/csvFiles/finalResults.csv.
 */
