...
/**
 * Get the path to the resource data/electionTwoPartyPrimary/election.json.
 */
function getResourcePath(): string {
  let rootDir = __dirname;
  do {
    if (existsSync(join(rootDir, 'package.json'))) {
      return join(rootDir, 'data/electionTwoPartyPrimary/election.json');
    }
...
/**
 * MIME type of data/electionTwoPartyPrimary/election.json.
 */
...
/**
 * Convert to a `data:` URL of data/electionTwoPartyPrimary/election.json, suitable for embedding in HTML.
 */
...
/**
 * Raw data of data/electionTwoPartyPrimary/election.json.
 */
...
/**
 * Text content of data/electionTwoPartyPrimary/election.json.
 */
...
/**
 * Full election definition for data/electionTwoPartyPrimary/election.json.
 */
...
/**
 * Election definition for data/electionTwoPartyPrimary/election.json.
 */
...
/**
 * Election package for data/electionTwoPartyPrimary/election.json.
 */
