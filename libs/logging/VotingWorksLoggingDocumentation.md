...
### sysfs-open-fd
**Type:** [system-action](#system-action)  
**Description:** An attempt was made to open a file descriptor for the sysfs GPIO interface.  
**Machines:** vx-mark-scan-pat-daemon
### sysfs-write-file
**Type:** [system-action](#system-action)  
**Description:** An attempt was made to interact with the sysfs GPIO interface by writing to a file.  
**Machines:** vx-mark-scan-pat-daemon
### gpio-pin-operation-init
**Type:** [system-action](#system-action)  
**Description:** A GPIO pin operation was attempted (export, unexport, or set direction)  
**Machines:** vx-mark-scan-pat-daemon
### gpio-pin-operation-complete
**Type:** [system-action](#system-action)  
**Description:** A GPIO pin operation was completed (export, unexport, or set direction)  
**Machines:** vx-mark-scan-pat-daemon
### close-file-descriptor-error
**Type:** [system-status](#system-status)  
**Description:** An error occurred when closing a file descriptor.  
**Machines:** vx-mark-scan-pat-daemon
...
**Type:** [system-status](#system-status)  
**Description:** mark-scan controller daemon encountered an error when handling data resulting from a button press.  
**Machines:** vx-mark-scan-controller-daemon
### unexpected-error-on-serial-port-read
**Type:** [system-status](#system-status)  
**Description:** mark-scan controller daemon encountered an error when attempting to read from the serial port.  
**Machines:** vx-mark-scan-controller-daemon
### unknown-error
**Type:** [application-status](#application-status)  
