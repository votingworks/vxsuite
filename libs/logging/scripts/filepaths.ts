...
export const checkTypescriptOutputTempFilepath = `${__dirname}/temp_check_generate_output.ts`;
export const checkRustOutputTempFilepath = `${__dirname}/temp_check_generate_output.rs`;
