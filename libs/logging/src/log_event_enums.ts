...
const SetBallotCastingMode: LogDetails = {
  eventId: LogEventId.SetBallotCastingMode,
  eventType: LogEventType.UserAction,
  documentationMessage: 'A user has changed the ballot casting mode.',
  restrictInDocumentationToApps: [AppName.VxScan],
};
...
const AdminBallotAdjudicationComplete: LogDetails = {
  ...
  eventType: LogEventType.ApplicationAction,
  documentationMessage:
    'A client machine completed adjudication of a ballot and resolved its tags.',
  restrictInDocumentationToApps: [AppName.VxAdmin],
};
