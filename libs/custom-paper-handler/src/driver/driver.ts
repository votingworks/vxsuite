...
export class PaperHandlerDriver implements PaperHandlerDriverInterface {
  ...
  async setScanDimensions({
    horizontalDimensionInDots,
    maxVerticalDimensionInDots,
  }: {
    horizontalDimensionInDots?: number;
    maxVerticalDimensionInDots?: number;
  }): Promise<boolean> {
    if (horizontalDimensionInDots) {
      this.scannerConfig.scanHorizontalDimensionInDots =
        horizontalDimensionInDots;
    }
    if (maxVerticalDimensionInDots) {
      this.scannerConfig.scanMaxVerticalDimensionInDots =
        maxVerticalDimensionInDots;
    }
