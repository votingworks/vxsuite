...
import { CastVoteRecord, PollsState, PrecinctId } from '@votingworks/types';
...
import { buildPrintScanApp } from '../../src/print_scan_app';
import {
  createInterpreter,
...
export async function createApp(
  ...
  const app = buildPrintScanApp(interpreter, workspace, logger);
