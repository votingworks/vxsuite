...
const Content = styled.div`
  flex: 1;
`
const AbsenteeHeader = styled.div<{ tintColor?: string }>`
  display: flex;
  align-items: center;
  justify-content: center;
  margin-bottom: 0.125in;
  background: ${({ tintColor = 'none' }) => tintColor};
  height: 0.25in;
  text-transform: uppercase;
  letter-spacing: 0.025in;
  color: #ffffff;
`
const AbsenteeFooter = styled.div<{ tintColor?: string }>`
  display: flex;
  align-items: center;
  justify-content: center;
  margin-right: 0.08in;
...
export const HandMarkedPaperBallot = ({
  ballotStyleId,
  election,
  electionHash,
  isLiveMode = true,
    ...
    <React.Fragment>
      <Ballot aria-hidden data-ballot ref={ballotRef}>
        <div className="ballot-footer">
          <PageFooter>
            {isAbsenteeMode && (
              <AbsenteeFooter tintColor={absenteeTintColor}>
                <Text bold as="span">
                  Absentee Ballot
                </Text>
              </AbsenteeFooter>
        ...
        <Content>
          <CandidateContestsLayout>
            <IntroColumn>
              {isAbsenteeMode && (
                <AbsenteeHeader tintColor={absenteeTintColor}>
