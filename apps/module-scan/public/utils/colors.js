...
/**
 * @param {Record<PropertyKey, string>} colors
 * @returns {Generator<string>}
 */
export function* iterator(colors) {
 ...
 */
export function map(colors) {
  const iter = iterator(colors)
  const lookup = /** @type {Map<T, string>} */ (new Map())

  return (value) => {
    const color = lookup.get(value)
