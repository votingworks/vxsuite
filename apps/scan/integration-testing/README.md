# VxScan Integration Testing

Integration tests for VxScan using the backend (`apps/scan/backend`), frontend
(`apps/scan/frontend`), and dependent services. These tests drive the real app
