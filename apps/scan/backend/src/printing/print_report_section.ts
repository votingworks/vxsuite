...
import { PartyId, PollsTransitionType } from '@votingworks/types';
...
export function getTallyReportPartyIds(
  store: Store
  ...
  return getPartyIdsForPrecinctScannerTallyReports(electionDefinition);
}
