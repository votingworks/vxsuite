...
export interface WithSimpleCustomScannerAppOptions {
  delays?: Partial<Delays>;
  preconfiguredWorkspace?: Workspace;
  logger?: Logger;
}

export interface WithSimpleCustomScannerAppCallbackParameter {
...
export async function withSimpleCustomScannerApp(
  {
    delays = {},
    preconfiguredWorkspace,
    logger = fakeLogger(),
  }: WithSimpleCustomScannerAppOptions,
  callback: (
    retVal: WithSimpleCustomScannerAppCallbackParameter
  ) => Promise<void>
): Promise<void> {
