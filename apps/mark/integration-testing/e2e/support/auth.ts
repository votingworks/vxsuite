 ...
 * later reconfigured with a different election) references a now-missing ballot
 * style and crashes the app on boot. Workaround for
 * https://github.com/votingworks/vxsuite/issues/8553 — remove once fixed.
 */
export async function endCardlessVoterSession(page: Page): Promise<void> {
