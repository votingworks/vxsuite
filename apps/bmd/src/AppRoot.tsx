...
const AppRoot: React.FC<Props> = ({
  ...
  const setDocumentFontSize = useCallback(
    (textSize: number = GLOBALS.TEXT_SIZE) => {
  ...
  useEffect(() => {
    setDocumentFontSize(userSettingsTextSize)
    // Trigger application of “See More” buttons based upon scroll-port.
    window.dispatchEvent(new Event('resize'))
  }, [userSettingsTextSize, setDocumentFontSize])
