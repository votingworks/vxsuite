...
export type InputChangeEventFunction = React.ChangeEventHandler<
  HTMLInputElement
>
export type TextareaChangeEventFunction = React.ChangeEventHandler<
  HTMLTextAreaElement
>
export type SelectChangeEventFunction = React.ChangeEventHandler<
  HTMLSelectElement
>
