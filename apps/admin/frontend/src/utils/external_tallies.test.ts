...
describe('convertTalliesByPrecinctToFullExternalTally', () => {
  it.only('combines precincts as expected', () => {
    ...
    //   ballotStyles.flatMap((ballotStyle) =>
    ...
    //   'governor-contest-federalist',
    // ];
    const t = buildExternalTally(multiPartyPrimaryElection, 6, ballotStyles);
    expect(t.numberOfBallotsCounted).toEqual(4);
