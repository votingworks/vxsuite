...
/**
 * Information necessary to display a hmpb option on the frontend.
 */
export interface HmpbImageView {
  ...
  readonly contestOptions: readonly BallotPageContestOptionLayout[];
  readonly side: Side;
}

/**
 * Information necessary to display a bmd option on the frontend.
 */
