...
// import wrapText from 'svg-text-wrap';
...
// TODO
// - Text wrapping in candidate names
...
//   options: { gap: number }
// ): DocumentElement[] {
//   const flow: DocumentElement[] = [];
//   let x = 0;
//   for (const element of elements) {
//     flow.push({ ...element, x: element.x + x });
//     x += element.width + options.gap;
//   }
//   return flow;
// }
...
//   let y = 0;
//   for (const element of elements) {
//     flow.push({ ...element, y: element.y + y });
//     y += element.height + options.gap;
//   }
//   return flow;
// }
...
// }: {
//   gap: number;
//   children: Array<OmitUnion<DocumentElement, 'width'>>;
// } & Omit<
//   RectangleElement,
//   'type' | 'height' | 'x' | 'y' | 'children'
// >): RectangleElement {
//   const childrenWithWidth = children.map((child) => ({
//     ...child,
//     width,
//   }));
//   const childrenFlow = flowVertical(childrenWithWidth, { gap });
//   return {
//     type: 'Rectangle',
//     x: 0,
//     y: 0,
...
//   // TODO Problem: TextBox needs a width to wrap lines and compute height.
//   // VerticalFlow needs children's height to flow them and compute its height.
//   // We need the VerticalFlow's width to get passed down to the TextBox before laying out the TextBox.
//   // This suggests we might need a two-phase approach - defining the containment
//   // relationships and specified attributes first, then computing the layout.
//   // (Similar to HTML and CSS.)
//   const header: RectangleElement = {
//     type: 'Rectangle',
...
//           }),
//         ],
//         gap: FontStyles.H3.lineHeight / 4,
//       }),
//       {
//         type: 'Image',
...
//   const instructions: RectangleElement = {
//     type: 'Rectangle',
...
//   totalPages: number;
// }): RectangleElement {
//   const continueVoting: DocumentElement[] = [
//     {
//       type: 'TextBox',
...
//   const ballotComplete: DocumentElement[] = [
//     {
//       type: 'TextBox',
...
//   const heading: RectangleElement = {
//     type: 'Rectangle',
//     ...gridPosition({ row: 0, column: 0 }),
...
//   const options: RectangleElement[] = contest.candidates.map(
//     (candidate, index) => ({
//       type: 'Rectangle',
//       ...gridPosition({
...
//   const contestColumns: RectangleElement = {
//     type: 'Rectangle',
...
//         contestColumns,
//       ].filter((child): child is DocumentElement => child !== null),
//     });
//   }
