...
export function EditPanel(props: {
  ...
  const { languageCode, jurisdictionId, onModeChange, ttsDefault, textOnly } =
    props;

  const { electionId, ttsMode = 'text' } = useParams<
    BallotAudioPathParams & { ttsMode: TtsExportSource }
  >();
