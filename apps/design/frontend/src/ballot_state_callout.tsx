...
export function BallotStateCallout(): React.ReactNode {
  ...
  if (approved) {
    return (
      ...
      >
        Ballots are finalized and ready for download.
      </Callout>
    );
  }
...
// [TODO] Consider moving title into base CalloutBase component.
function Callout(
  props: CalloutProps & {
