...
export function ExportScreen(): JSX.Element | null {
  ...
  const getBallotsApprovedAtQuery = getBallotsApprovedAt.useQuery(electionId);
  ...
  if (
    !(
      ...
      getBallotsApprovedAtQuery.isSuccess &&
  ...
  const hasDownloads =
    !!electionPackageQuery.data.task?.completedAt ||
    !!testDecksQuery.data.task?.completedAt;
          ...
          <React.Fragment>
            ...
            >
              ...
              {exportError && (
                ...
                >
                  An unexpected error occurred while exporting. Please try
                  again.
                </Callout>
              )}
              ...
              <CheckboxButton
                ...
                onChange={(isChecked) =>
                  setShouldExportSampleBallots(isChecked)
                }
              />
