...
const EITHER_NEITHER_CVR_PATH = join(
  electionWithMsEitherNeitherInternal.cvrDataFolderPath!,
  'standard.txt'
)
...
const EITHER_NEITHER_SEMS = path.join(
...
it('tabulating CVRs with SEMS file', async () => {
  ...
  const semsFileContent = await fs.readFileSync(EITHER_NEITHER_SEMS)
